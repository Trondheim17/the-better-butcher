...
(2477, 7.69, 'Brisket Flat Half', 'The leaner half of the whole Brisket also known also as the “first cut,” this full-flavored meat can be sliced or shredded.', 'embed.widencdn.net/img/beef/ax42lrqvmz/800x600px/Brisket_Flat%20Cut_Boneless_120A.psd?keep=c&u=7fueml'),
...
(2753, 3.79, 'Chuck Tender', 'The name of this cut comes from its shape—long and narrow with a pointed tip, similar to a Tenderloin—rather than its tenderness.', 'embed.widencdn.net/img/beef/czfvpgkjbn/exact/Chuck Tender.psd?u=7fueml'),
(2754, 2.89, 'Chuck Roll', 'This large, boneless cut comes from between the ribs and backbone. Contains a mix of tender and somewhat tough muscles.', 'embed.widencdn.net/img/beef/kevnnxelax/exact/Chuck Roll_116A.psd?u=7fueml'),
(2761, 1.13, 'Petite Sirloin Steak', 'A great value steak. Grill after marinating.', 'embed.widencdn.net/img/beef/lqdbgqwtg7/exact/Petite Sirloin Steak.psd?u=7fueml'),
(2772, 13.99, 'T-Bone Steak', 'Smaller than the Porterhouse, but delivers same optimal tenderness and satisfying flavor – all in a lean package that’s ready to be grilled.', 'embed.widencdn.net/img/beef/ct62lm01nw/exact/T-Bone Steak.psd?u=7fueml'),
(2775, 8.99, 'Top Sirloin Steak', 'A flavorful cut that’s versatile and juicy. Great served as a steak or cut into kabobs.', 'embed.widencdn.net/img/beef/melpznnl7q/exact/Top Sirloin Steak.psd?u=7fueml'),
(2790, 5.99, 'Bottom Round (Gooseneck)', 'This lean, economical cut comes from the outside of the rear leg. It is generally best when braised.', 'embed.widencdn.net/img/beef/wlnznmr0i3/exact/Bottom (Gooseneck) Round_170.psd?u=7fueml'),
(2791, 5.99, 'Eye of Round', 'This extremely lean cut is shaped similar to a Tenderloin, but is much less tender. It is often packaged as a roast or steaks.', 'embed.widencdn.net/img/beef/v8er78gi56/exact/Eye of Round.psd?u=7fueml'),
(2813, 7.79, 'Chuck Neck Roast', 'Rich in flavor and tender after slow-cooking.', 'embed.widencdn.net/img/beef/7y4c2eohle/exact/Chuck Neck Roast.psd?u=7fueml'),
(2814, 2.59, 'Chuck Short Ribs', 'A crowd favorite, known for their richness and meatiness. Flavorful, moist and tender when slow-cooked.', 'embed.widencdn.net/img/beef/kipsqvehbz/exact/Short Ribs_Chuck.psd?u=7fueml'),
(2826, 11.99, 'Hanger Steak', 'A thicker cut within the Short Plate that’s full of flavor with a coarse texture. Marinate and grill.', 'embed.widencdn.net/img/beef/lzvcy3ljor/exact/Hanger Steak.psd?u=7fueml'),
(2828, 5.49, 'Bottom Sirloin Butt', 'This lower portion of the Sirloin section of the Loin that contains three muscles that vary in tenderness.', 'embed.widencdn.net/img/beef/gnacbahkln/exact/Bottom Sirloin_185_DSC_2037.psd?u=7fueml'),
(2834, 14.49, 'Loin Steak Tail', 'Cut from the underside or Flank portion of the beef hindquarter, ventral or under the Short Loin. Fat trim level is specified by the buyer.', 'embed.widencdn.net/img/beef/3subqxyq0d/exact/Loin Steak Tail_176_DSC_2053.psd?u=7fueml'),
(2847, 5.99, 'Outside Round (Flat)', 'Largest section of the full Bottom Round that is separated from the Heel and can be cut into Bottom Round Roasts or Steaks.', 'embed.widencdn.net/img/beef/kkcdpak7do/exact/Bottom Round_Flat_Denuded.tif?u=7fueml'),
(2848, 5.77, 'Inside Skirt', 'Opposite the Outside Skirt Steak, this cut is known for its robust flavor profile. Marinate and grill hot for fajitas or use for stir-fry.', 'embed.widencdn.net/img/beef/rufkduagts/exact/Inside Skirt_121D.JPG?u=7fueml'),
(2849, 6.89, 'Outside Skirt', 'Opposite the Inside Skirt Steak, this cut is known for its robust flavor profile. Marinate and grill hot for fajitas or use for stir-fry.', 'embed.widencdn.net/img/beef/sftlhjegmy/exact/Outside Skirt_Trimmed_121C.psd?u=7fueml'),
(2854, 12.99, 'Ribeye Cap Roll', 'Rich and satisfying with exceptional tenderness and marbling. Not always easy to find, but best when roasted.', 'embed.widencdn.net/img/beef/rajnv2jiku/exact/Ribeye Roll_Lip-on.tif?u=7fueml'),
(2855, 14.99, 'Ribeye Cap Steak', 'Rich and satisfying with exceptional tenderness and marbling.  Perfect for grilling .', 'embed.widencdn.net/img/beef/akfvcsqc6h/exact/Ribeye Cap Steak.psd?u=7fueml'),
(2863, 5.99, 'Outside Round, Heel', 'Smaller section of the full Bottom Round that is separated from the Outside Round (Flat).', 'embed.widencdn.net/img/beef/fxvsvugrbt/exact/Outside Round_Heel.jpg?u=7fueml'),
(2879, 4.09, 'Chuck Arm Roast', 'Economical and flavorful. Best when slow-cooked.', 'embed.widencdn.net/img/beef/b4oefjv7ez/exact/Chuck Arm Roast.psd?u=7fueml'),
(2882, 9.89, 'Strip Steak, Boneless', 'Tender, lean and perfect for grilling. ', 'embed.widencdn.net/img/beef/35tign8hsg/exact/Strip Loin Steak.psd?u=7fueml'),
(2918, 3.09, 'Country-Style Ribs', 'Meaty, boneless ribs that work best in a slow-cooker or slow-cooked and finished on the grill.', 'embed.widencdn.net/img/beef/qeerk16a5p/exact/Country Style Ribs.psd?u=7fueml'),
(2951, 13.69, 'Brisket', "This the animal's breast, so it can be tougher because it is used for movement. An ideal cut for cooking low and slow.", 'embed.widencdn.net/img/beef/0ihtghs7iy/exact/Brisket_Deckle Off.psd?u=7fueml'),
(44450, 7.79, 'Chuck Flap/Edge Roast', 'Richly flavored and finely textured. Best for slow-cooking whole or grilling if very thinly sliced across the grain.', 'embed.widencdn.net/img/beef/lczhkug2xw/exact/Under Blade_Center-Cut_Edge Roast_116G PSO 1.jpg?u=7fueml'),
(44457, 1.13, 'Petite Sirloin/Ball Tip', 'Small roast section of the Bottom Sirloin opposite the Sirloin Tip in the Round. Best when sliced thinly across the grain after cooking.', 'embed.widencdn.net/img/beef/pixobggurd/exact/Ball Tip_Fat On.psd?u=7fueml'),
(44465, 11.69, 'Brisket Point Half', 'The less lean half of the whole Brisket that’s juicy with full flavor. ', 'embed.widencdn.net/img/beef/rgvs4fvelm/exact/Brisket Point.psd?u=7fueml'),
(44466, 2.49, 'Plate Short Ribs', 'Good beef flavor. Good braised or on the grill with your favorite rub.', 'embed.widencdn.net/img/beef/tbtkudbsls/exact/Short Ribs_Plate.psd?u=7fueml'),
(44469, 8.98, 'Cowboy Steak', 'Tender, bone-in steak with a frenched rib presentation that is great for the grill.', 'embed.widencdn.net/img/beef/4j5r0zo68l/exact/FreshPhoto_Fabrication_FrenchedCowboyCut_psd.psd?u=7fueml'),
...
(44489, 16.99, 'Prime Rib Roast', 'Bone-in Rib roast perfect for roasting and entertaining.', 'embed.widencdn.net/img/beef/m6lg3sgm16/exact/Ribeye Roast_Bone In_Prime Rib.jpg?u=7fueml'),
...
(44493, 6.99, 'Short Rib Osso Bucco', 'Long-bone short ribs cut and tied for an osso bucco style presentation.', 'embed.widencdn.net/img/beef/j14ri9mycg/exact/Short Rib Osso Bucco.jpg?u=7fueml'),
